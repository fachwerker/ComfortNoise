...
class RecordStereoMicLabels @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : View(context, attrs, defStyleAttr) {
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        val labels: Array<Label> = arrayOf(
            Label("1",height*1/10f),
            Label("2",height*2/10f),
            Label("3",height*3/10f),
            Label("4",height*4/10f),
            Label("5",height*5/10f),
            Label("6",height*6/10f),
            Label("7",height*7/10f),
            Label("8",height*8/10f),
            Label("9",height*9/10f),
        )
        for (label in labels) {
